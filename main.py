...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR100', 'CIFAR10', 'IMNET'],
...
def main(args):
    ...
    if args.load_gene:
        ...
        if args.data_set == 'IMNET':
            checkpoint = utils.gene_tranfer(args, checkpoint, len(model_without_ddp.blocks), load_head=True)
        else:
            checkpoint = utils.gene_tranfer(args, checkpoint, len(model_without_ddp.blocks), load_head=False)
